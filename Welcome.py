def welcomeInstructions ():
    input("Welcome to Minesweeper! Press enter to view the instructions...")
    my_string = '''The game begins on a grid of unmarked squares - type the coordinates of a box to start the game. 
